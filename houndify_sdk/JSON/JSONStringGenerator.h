/* file "JSONStringGenerator.h" */

/* Copyright 2015 SoundHound, Incorporated.  All rights reserved. */

#ifndef JSONSTRINGGENERATOR_H
#define JSONSTRINGGENERATOR_H

#include "JSONCheckingHandler.h"


class JSONStringGenerator : public JSONCheckingHandler
  {
  protected:
    JSONStringGenerator(void);
    ~JSONStringGenerator(void);

    virtual void handle_result(const char *result) = 0;
    virtual void validate(const char *result)  { }
