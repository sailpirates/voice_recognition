/* file "JSONArrayGenerator.h" */

/* Copyright 2015 SoundHound, Incorporated.  All rights reserved. */

#ifndef JSONARRAYGENERATOR_H
#define JSONARRAYGENERATOR_H

#include "JSONCheckingHandler.h"


class JSONArrayGenerator : public JSONCheckingHandler
  {
  private:
    size_t depth;
    JSONHandler *element_handler;

  protected:
    JSONArrayGenerator(void);
    ~JSONArrayGenerator(void);

    virtual JSONHandler *start(void) = 0;
