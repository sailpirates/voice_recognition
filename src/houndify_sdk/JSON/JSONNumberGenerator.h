/* file "JSONNumberGenerator.h" */

/* Copyright 2015 SoundHound, Incorporated.  All rights reserved. */

#ifndef JSONNUMBERGENERATOR_H
#define JSONNUMBERGENERATOR_H

#include "JSONCheckingHandler.h"


class JSONNumberGenerator : public JSONCheckingHandler
  {
  protected:
    JSONNumberGenerator(void);
    ~JSONNumberGenerator(void);
