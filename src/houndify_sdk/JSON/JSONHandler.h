...
/* Copyright 2012-15 SoundHound, Incorporated.  All rights reserved. */
...
class JSONHandler
  ...
  public:
    ...
    virtual void number_value(double to_write, int precision = DBL_DIG)  { }
    ...
    virtual void pair(const char *name, double value, int precision = DBL_DIG)
      { }
