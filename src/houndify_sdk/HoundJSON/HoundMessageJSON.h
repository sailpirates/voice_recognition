...
class HoundMessageJSON : public ReferenceCounted
  ...
  private:
    ...
    HoundMessageJSON(const HoundMessageJSON &)  { assert(false); }
    HoundMessageJSON &operator=(const HoundMessageJSON &other)  { assert(false); throw "Illegal operator=() call."; }
  ...
  public:
    ...
    bool hasValue(void) const  { return flagHasValue; }
